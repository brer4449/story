        ...
        <div className="card text-center">
          <div className="card-body">
            ...
            <div className="row py-4">
              <div className="col-2"></div>
              <div className="col-4">
                <h3>Joseph Schmidt</h3>
                <p className="text-right">
                  Joseph has always been fascinated by storytelling. Joseph is
                  currently honing his craft in South Dakota. When not writing
                  he enjoys induging in film, is a tech nerd, and loves to read.
                </p>
              </div>
              <div className="col-4">
                <img
            ...
            <div className="row py-4">
              ...
              <div className="col-4">
                <h3>Carolani Bartell</h3>
                <p className="text-left">
                  Carolani is a writer from the DMV area. She has been working
                  in the entertainment industry since childhood, recently
                  writing for video games, internet content, and wonderful
                  projects like these. She also writes and edits fiction, music,
                  and screenplays, finding inspiration in just about any
                  creative outlet. Her passion for storytelling is often
                  accompanied by early mornings, a record player, and iced
                  coffee.
                </p>
              </div>
              <div className="col-2"></div>
